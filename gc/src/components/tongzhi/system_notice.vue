<template>
  <div class="system_notice-container">
      ...
      <div class="zhong">
          <div class="none">
              <div class="none1">
                  <p class="shang">没有任何通知</p>
              </div>
              <div class="none1">
                  <p class="xia">在这里看到相关通知内容</p>
              </div>
...
.system_notice-container::-webkit-scrollbar{
  width: 0 !important;
  height: 0;
}//隐藏滚动条
</style>